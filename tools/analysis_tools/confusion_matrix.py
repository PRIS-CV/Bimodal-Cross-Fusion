...
def parse_args():
    ...
    # swin-L pixray DINO
    parser.add_argument('--config', default='configs/dino/DINO_r50_opixray.py',
...
def plot_confusion_matrix(confusion_matrix,
    ...
    fig, ax = plt.subplots(
        figsize=(0.8 * num_classes,0.8 * num_classes * 0.8), dpi=300)
