...
def parse_args():
    ...
    '''
    # AO-DETR r50 pixray
    parser.add_argument('--config', default='./configs/dino/AO-DETR-DM_r50_opixray.py', help='train config file path')
    parser.add_argument('--work-dir', default='../autodl-tmp/checkpoint/ao-detr_dm_v2/r50_opixray/train/lr_mult_1_num_level_1', help='the dir to save logs and models')
