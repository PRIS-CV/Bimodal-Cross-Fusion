...
def parse_args():
    ...
    parser.add_argument('--config', default='../autodl-tmp/checkpoint/ao-detr_dm_v3/r50_opixray/train/lr_mult_1/AO-DETR-DM_r50_opixray.py')
    parser.add_argument('--checkpoint', default='../autodl-tmp/checkpoint/ao-detr_dm_v3/r50_opixray/train/lr_mult_1/best_pascal_voc_mAP_epoch_19.pth',
                        help='the dir to save logs and models')
