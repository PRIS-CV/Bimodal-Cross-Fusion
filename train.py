...
def parse_args():
    ...
    '''
    # AO-DETR r50 pixray
    parser.add_argument('--config', default='./configs/dino/AO-DETR-DM_r50_pixray.py', help='train config file path')
    parser.add_argument('--work-dir', default='./checkpoint/ao-detr_dm/r50_pixray/train', help='the dir to save logs and models')
