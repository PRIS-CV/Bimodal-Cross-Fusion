...
def parse_args():
    ...
    parser.add_argument('--config', default='./configs/dino/AO-DETR_r50_pixray.py')
    parser.add_argument('--checkpoint', default=r'G:\Xray-detection-checkpoint\PIXray\AO-DETR\AO-DETR_v2\epoch_23.pth',
                        help='the dir to save logs and models')
    ...
    parser.add_argument(
        '--out',
        default='PklForConfusion/OPIXray/AO-DETR/epoch24.pkl',
        type=str,
